...
SEED_MAP = {
    "math": [
        "radical", "slope", "graph", "transformation", "equation", "function", 
        "variable", "coefficient", "polynomial", "addition", "subtraction", 
        "multiplication", "division", "fraction", "exponent", "logarithm", 
        ...
        "derivative", "integral", "matrix","quadratic", "logarithm", "probability", 
        "fraction", "decimal", "graphing", "coordinate", "inequality", 
        "coefficient", "exponent", "factoring", "parabola",
    ],
    ...
    "physics": [
        ...
        "joule", "watt", "pascal", "hertz", "faraday", "coulomb", "planck",
        "mass", "energy", "work", "power", "frequency", "amplitude", "impulse",
        "momentum", "inertia", "acceleration", "velocity", "displacement",
        "speed", "time", "distance", "force", "gravity", "friction", "normal force",
        "tension", "spring", "circular motion", "centripetal force",
        "angular momentum", "torque", "moment of inertia", "simple harmonic motion",
    ],
    ...
    "english": [
        ...
        "rhetoric",  "diction", "tone", "mood", "annotation",
        "close reading", "textual evidence", "literary device",
        "iambic pentameter", "sonnet", "hamlet", "macbeth", "othello",
        "thesis", "theme", "foreshadowing", "irony", "imagery", "author",
        "narrative", "point of view", "genre", "literature", "vocabulary",
        "annotation", "book report", "essay", "composition", "creative writing", 
        "poetry", "vocab", "literary", "analysis", "close reading", "pronoun", 
        "adjective", "adverb", "preposition", "conjunction", "interjection", "sentence", 
        "paragraph", "heroes journey", "writing", "draft", "revision", 
    ...
    "history": [
        "history", "hist", "war", "revolution", "civilization", "ancient", "glory",
        "medieval", "colonial", "wwi", "wwii", "ww1", "ww2", "civil war",
        "empire", "constitution", "amendment", "timeline", "gold", "god", "religion",
        "renaissance", "reformation", "enlightenment", "industrial revolution",
        "cold war", "holocaust", "slavery", "manifest destiny", "dynasty", "imperialism",
        "treaty", "declaration", "founding fathers", "monarchy", "feudalism",
        "crusades", "colonialism", "conquer", "nationalism", "socialism", "communism", 
        "capitalism", "fascism", "democracy", "republic", "anarchy", "totalitarianism", 
        "authoritarianism", "oligarchy", "sufferage", "civil rights", "activism", "protest", 
        "reform", "progressive", "conservative",  "geography", "geo", "map", "continent", "country",
        "biome", "latitude", "longitude", "population", "migration","region", "topography", "river",
        "mountain", "ocean","cartography", "hemisphere", "equator", "urban", "rural","demographic", 
        "peninsula", "island", "plateau", "delta","tectonic", "monsoon", "savanna", "tundra", 
        "rainforest", "states", "capitals"
    ],
    ...
    "art": [
        ...
        "printmaking", "ceramics", "collage", "still life", "watercolor"
    ],
    ...
    "band": [
        ...
        "bass", "vocal", "euphonium", "woodwind", "brass", "string", "orchestra", "precussion"
    ...
    "pe": [
        ...
        "hydration", "stretching", "athletic", "olympic", "soccer", "basketball", 
        "frisbee", "football", "volleyball", "pickleball",  "yoga", "meditation", 
        "wrestling", "mile", "run", "jump", "throw", "swim", "biking", "hike", "climb",
        "team", "roster",
    ],
...
SUBJECT_DESCRIPTIONS = {
    ...
    "english": (
        ...
        "figurative language, rhetoric, close reading, and textual evidence, as well as "
        "writing — essays, creative writing, narratives, persuasive arguments, poetry, drafts, "
        "and revision — and reading comprehension, vocabulary, fiction and nonfiction texts, "
        "book reports, summarizing, and inference."
    ),
    "history": (
    ...
    "band": (
        "Band and music class covering music theory, notes, chords, rhythm, melody, "
...
CATEGORY_MAP = {
    ...
    ".yaml": "computer science",
    ".yml": "computer science",
    ".sh": "computer science",
